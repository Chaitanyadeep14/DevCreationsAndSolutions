...
const products = {
  ...
  "banners": {
    ...
    mainImage: "./images/banner/full-view.png",
    thumbnails: [
    ...
    "posters": {
      ...
      mainImage: "./images/posters/full-view.png",
      thumbnails: [
        "./images/posters/front-view.png",
        "./images/posters/back-view.png",
        "./images/posters/blueprint.png",
      ],
    ...
    "brochures": {
      ...
      "stickers": {
        ...
        mainImage: "./images/stickers/full-view.png",
        thumbnails: [
          "./images/stickers/front-view.png",
          "./images/stickers/back-view.png",
          "./images/stickers/blueprint.png",
        ],
      ...
      "danglers": {
        ...
        mainImage: "./images/danglers/full-view.png",
        thumbnails: [
          "./images/danglers/front-view.png",
          "./images/danglers/back-view.png",
          "./images/danglers/blueprint.png",
        ],
